...
FinReport achieved superior performance compared to baseline LSTM models, reducing RMSE by 15\% and MAE by 12\% across the 75-stock evaluation dataset \cite{Fischer2018}. The multi-factor enhancement contributed significantly to predictive accuracy improvement, with sentiment integration providing additional 8\% performance gain over purely technical models.
